...
export const metadata = {
  "name": "USDC",
  "primaryContract": "code//Users/quang.lam/Documents/GitHub/stablecoin-evm-private-usdc-cbase-testnet/contracts/v2/FiatTokenV2_2.sol:FiatTokenV2_2",
  "abiFile": "abi.ts",
  "methods": {
    "owner()": {
  ...
  "errors": {},
  "bytecodeHash": "0x8e01f4a500e92096e4ffbec2ce485fea179988b38b3c773a0ce458cab58cc6a6",
  "contractFileTree": {
    "code": {
      "@openzeppelin": {
        "contracts": {
      ...
      "": {
        "Users": {
          "quang.lam": {
            "Documents": {
              "GitHub": {
                "stablecoin-evm-private-usdc-cbase-testnet": {
                  "contracts": {
                    "v1": {
                      "Ownable.sol": "",
                      "Pausable.sol": "",
